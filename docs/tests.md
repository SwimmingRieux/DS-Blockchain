...
2.  **Command:** `AddTransactionToMempool '{'''inputs''': [{'''prevTxId''': '''abc...''', '''prevOutIndex''': 0, '''publicKey''': '''02...''', '''signature''': '''30...'''}], '''outputs''': [{'''value''': 5000, '''publicKey''': '''02...'''}, {'''value''': 2000, '''publicKey''': '''03...'''}]}'`
...
2.  **Command:** `AddTransactionToMempool '{'''inputs''': [{'''prevTxId''': '''abc...''', '''prevOutIndex''': 0, '''publicKey''': '''02...''', '''signature''': '''30...'''}], '''outputs''': [{'''value''': 5001, '''publicKey''': '''02...'''}, {'''value''': 2000, '''publicKey''': '''03...'''}]}'`
3.  **Expected Outcome:** The transaction should be rejected due to a signature verification failure. Your program should output an error message.
    ```
...
---
[← Back: Milestones & Checklists](milestones.md) · [Next: Getting Started →](getting-started.md)